...
function App() {
  ...
  return (
    ...
    <div className="flex min-h-screen justify-center items-center">
      <div className="relative bg-gradient-to-br from-green-300 to-yellow-100 p-6 rounded-lg shadow-2xl shadow-green-900 w-90">
        
        {/* Profile Picture */}
        <div className="flex justify-center">
          <img src="https://clipartcraft.com/images/assassins-creed-logo-gold.png" alt="Profile Picture" className="rounded-full w-28 h-28" />
        </div>
        ...
        <div className="mt-8 space-y-6">
          ...
          <a href="#" className="block bg-white rounded-full text-center p-3 shadow-md shadow-black hover:bg-gray-100">
